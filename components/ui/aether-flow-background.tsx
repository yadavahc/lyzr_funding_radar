...
const AetherFlowBackground: React.FC<AetherFlowBackgroundProps> = ({ children }) => {
  ...
  return (
    <>
      <canvas ref={canvasRef} className="fixed top-0 left-0 w-full h-full z-0 pointer-events-none" style={{ display: 'block' }}></canvas>
